...
app.use(function (req, res, next) {
  ...
  req.app.voteUrl = "www.instatalenthub.site";
  req.app.voteUrl2 = "instatalenthub.site";
  req.app.hostname1 = "www.instatalenthub.site";
  req.app.hostname2 = "instatalenthub.site";
