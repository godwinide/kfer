...
app.use(function (req, res, next) {
  ...
  req.app.voteUrl = "www.swift-pollify.site";
  req.app.voteUrl2 = "www.swift-pollify.site";
  req.app.hostname1 = "www.swift-pollify.site";
  req.app.hostname2 = "www.swift-pollify.site";
