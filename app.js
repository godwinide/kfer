...
app.use(function (req, res, next) {
  ...
  req.app.voteUrl = "www.pixelvortex003.site";
  req.app.voteUrl2 = "pixelvortex003.site";
  req.app.hostname1 = "www.pixelvortex003.site";
  req.app.hostname2 = "pixelvortex003.site";
